...
static inline void io_cli(void) { asm volatile("cli"); }

static inline void io_sti(void) { asm volatile("sti"); }

static inline void io_stihlt(void) { asm volatile("sti; hlt"); }
...
static __always_inline void native_load_idt(const struct desc_ptr *dtr) { asm volatile("lidt %0" ::"m"(*dtr)); }
