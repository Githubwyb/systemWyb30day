...
static void init_screen(u8 *vram, int xsize, int ysize) {
    ...
    put_font8(vram, xsize, 8, 10, COL8_FFFFFF, 'A');
    put_font8(vram, xsize, 16, 10, COL8_FFFFFF, 'B');
    put_font8(vram, xsize, 24, 10, COL8_FFFFFF, 'C');

    put_font8(vram, xsize, 40, 10, COL8_FFFFFF, '1');
    put_font8(vram, xsize, 48, 10, COL8_FFFFFF, '2');
    put_font8(vram, xsize, 56, 10, COL8_FFFFFF, '3');
}
